            ...
            if (data === undefined) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var divcontent3 = '<span>' + data[i].DatePublished + '</span>' +
                        '<i onclick="deleteComment(this)" data-userId = ' + data[i].ApplicationUserId + ' data-commentId=' + data[i].CommentId + ' class="glyphicon glyphicon-remove"></i> <i class="fa fa-heart"></i></div><div class="comment-content">' +
